<template xmlns="">
  <div class="container">
    ...
    <!-- footer -->
    <div class="footer">
      Copyright © 2022-2023 mteass.top All Rights Reserved.
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getSmsCode() {
      ...
      this.$refs.loginForm.validate(valid => {
        if (!valid) return;
        sendSmsCode(this.loginForm.mobile, this.scene, this.loginForm.uuid, this.loginForm.code).then(() => {
